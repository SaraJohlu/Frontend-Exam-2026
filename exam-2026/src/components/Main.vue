...
<template>
    <div id="firstSide" class="mainApp">
        ...
        <header>
            <Navbar>
                <template #navbarSlot>
                    <div class="navbarContent">
                        <MainButton
                        aria-label="Information kring applikationen"
            ...
            <Modal ref="refModal" id="information-modal" aria-labelledby="" label="Information om projektet" >
                    <p class="modal-text">Denna applikation skapades i samband med min examen 2026, projketet är kopplat till min rapport som jag har skrivit om Accessibility i from av hur en frontend-utvecklare
